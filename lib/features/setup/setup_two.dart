...
class _SetupTwoState extends State<SetupTwo> {
  ...
  Widget build(BuildContext context) {
    bool checkInputs() {
      if (_streetController.text.trim().isEmpty || _cityController.text.trim().isEmpty || _suburbController.text.trim().isEmpty || _postalCodeController.text.trim().isEmpty || _bankController.text.trim().isEmpty || _branchCodeController.text.trim().isEmpty || _bicController.text.trim().isEmpty || _accountNumberController.text.trim().isEmpty) {
        return false;
      }
      else {
        return true;
