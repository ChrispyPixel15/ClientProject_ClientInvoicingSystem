...
class _ClientProfileState extends State<ClientProfile> {
  ...
  Future<void> getClientTaskList() async {
    ...
    setState(() {
      currentClientTaskList = newList.reversed.toList();
    });
    debugPrint(result.toString());
  }
  ...
  Future<void> getClientInvoices() async {
    ...
    setState(() {
      currentClientInvoices = newList.reversed.toList();
    });
    debugPrint(result.toString());
  }
  ...
  Future<void> getClientStatements() async {
    ...
    setState(() {
      currentClientStatementList = newList.reversed.toList();
    });
  }
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return InkWell(
                                    ...
                                    child: ClientListInvoice(invoiceNum: inv['invoice_number'], id: inv['id'], date: inv['date'], paid: inv['paid'], paidFunc: payInvoice, deleteFunc: activateDeleteInv, mailFunc: mailInvoice, isFirst: index == 0 ? true : false),
                                  );
                                },
                              ),
                            )                           
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return InkWell(
                                    ...
                                    child: ClientListStatement(statementNum: state['statement_number'], id: state['id'], date: state['date'], deleteFunc: activateDeleteState, mailFunc: mailStatement, isFirst: index == 0 ? true : false),
                                  );
                                },
                              ),
                            ) 
